...
like to enable your computer (SkyNet) to play the game (your hidden agenda is 
to prove once and for all that computers are inferior to human intellect!) In 
this part, you will be able to compare how you as a user succeed in the game 
compared to the computer's performance.
...
def playGame(wordList):
    ...
    def u_or_c():
        while True:
            ...
            if answer2 == "u":
                playHand(random_hand, wordList, HAND_SIZE)
                break
            elif answer2 == "c":
                compPlayHand(random_hand, wordList, HAND_SIZE)
                break
            else:
    ...
    while True:
        ...
        if answer1 == "n":
            count_new += 1
            random_hand = dealHand(HAND_SIZE)
            u_or_c()
        elif answer1 == "r":
            if count_new == 0:
